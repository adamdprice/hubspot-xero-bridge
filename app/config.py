...
class Settings(BaseSettings):
    ...
    # Minimum delay after each Accounting API response before the next call (process-wide). Raise to 2.5–3.0 if 429 persists.
    xero_api_min_interval_seconds: float = 2.0
